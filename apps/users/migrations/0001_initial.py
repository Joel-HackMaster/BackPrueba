# Generated by Django 5.0.6 on 2024-06-25 17:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nombre de Usuario')),
                ('last_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Apellidos')),
                ('profession', models.CharField(blank=True, default='Estudiante', max_length=255, null=True, verbose_name='Profesion')),
